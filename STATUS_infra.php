...
<div class="content pb-0">
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-12">
            <div class="card">
                <div class="card-header"> <strong>VULNERABIILITY INFRASTRUCTURE [<?php echo $data['id'];?>]</strong> <small></small>
                <form action="" method="post">
                    <div class="card-body card-block">
                        <div class="form-group">
                            <tr>
                                <label for="current_status" class="form-control-label">Current Status</label>
                                <td><input type="text" name="current_status" class="form-control" value="<?php echo $data['current_status']; ?>"></td>
                            </tr>
                        </div>
                        <div class="form-group">
                            <tr>
